...
caffe_root = 'D:/Training/Source_Code/Python/caffe/'

data = 'C:/Users/linhb/a6/forest_data.npz'
data = 'forest_data.npz'
score_all = [0.489617092786, 0.489617092786, 0.489617092786, 0.489617092786, 0.489617092786, \
          0.489617092786, 0.489617092786, 0.489617092786, 0.489617092786]
score_all = np.array(score_all).reshape(len(C),len(sigma))
...
def main(argv=None):
    ...
    print("Validation Accuracy for each parameter set:")
